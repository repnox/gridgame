<template>
  <div>
    <b-button v-b-toggle.quest-items-collapse variant="link"><font-awesome-icon icon="chevron-down"/> Quest Items</b-button>
    <b-collapse id="quest-items-collapse" class="mt-2">
      <b-card>
        <b-button v-b-toggle.quest-items-collapse size="sm" style="float:right">X</b-button>
        <div class="card-text">
          <h1>Quest Items</h1>
    ...
    <b-modal ref="modal" :title="'Edit Quest Item ' + selectedItem.hex" size="xl" hide-footer>
